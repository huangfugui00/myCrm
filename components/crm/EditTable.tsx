...
import {customerType,contactType} from 'utils/type'
...
type EditTableProp<T>={
    customer:T,
    handleUpdate:(customer:T)=>void
}

  

function  EditTable<T extends contentType>(props:EditTableProp<T>){
